...
class SchemaContext(SimpleItem):
    ...
    """
    # Implementing IBrowserPublisher tells the Zope 2 publish traverser to pay
    # attention to the publishTraverse and browserDefault methods.
    ...
    def browserDefault(self, request):
        """Show the schema edit form if not traversing through the schema.
        """
        return self, ('@@edit',)
